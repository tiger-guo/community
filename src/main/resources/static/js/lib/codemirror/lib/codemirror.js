...
(function(mod) {
  ...
  option("theme", "default-avatar.png", function(cm) {
    themeChanged(cm);
    guttersChanged(cm);
  }, true);
  option("keyMap", "default-avatar.png", function(cm, val, old) {
  ...
  keyMap["default-avatar.png"] = mac ? keyMap.macDefault : keyMap.pcDefault;
